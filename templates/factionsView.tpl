...
<div id="content">
    ...
    <div class="contentTabberPage">
        <div class="topTabs">
            <ul>
			<li class="dropdown active"><a class="dropdown-toggle active" data-toggle="dropdown" style="cursor:pointer;">اقلیت</a>
        ...
        <div class="subPageTitle pageTitle">
			...
			<p style="text-align:center"><img alt="" src="<?php echo $dnn['imageUrl'] ?>"></p>
                <div style="font-weight: bold; padding: 20px 0; font-size: 15px;">
						...
						?><br>
            زمان اتمام فرصت درخواست ثبت نام: <span dir=ltr><?php echo ($dnn['EndDate']) ? jdate("Y/m/d H:i:s", $dnn['EndDate']) : "تنظیم نشده"; ?></span><br>
            حداکثر تعداد درخواست ثبت نام: <?php echo ($dnn['MaxApps']) ? $dnn['MaxApps'] : "تنظیم نشده"; ?><br>
            حداقل سطح موردنیاز: <?php echo $dnn['MinLvl'] ?>
			
			<p style="text-align:left"><a target="_blank" href="<?php echo $dnn['forumUrl'] ?>">بخش اقلیت <?php echo $factions[($dnn['ID'])] ?> در انجمن</a></p>
			</div>
